...
*                        7-segmentsdisplayerna är aktiverat. Om uppräkning är
*                        aktiverat returneras true, annars false.
********************************************************************************/
...
void display_count(void)
{
   ...
   if (timer_elapsed(&timer_count_speed))
   {
      ...
      eeprom_write_byte(0, number);
	  eeprom_write_byte(3, display_count_enabled());
      digit1 = number / radix; 
      digit2 = number - digit1 * radix; 
   }
   return;
...
void display_toggle_count_direction(void)
{
   ...
   eeprom_write_byte(1, count_direction);
   return;
}
...
/********************************************************************************
* display_get_count_direction: Returnerar uppräkningsriktningen på
*                              7-segmentsdisplayerna som en enumator av
*                              enumerationen display_count_direction.
********************************************************************************/
enum display_count_direction display_get_count_direction(void)
{
...
*
*                        - digit: Siffran som ska skrivas ut.
********************************************************************************/
static inline void display_update_output(const uint8_t digit)
{
